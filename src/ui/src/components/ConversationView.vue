<template>
  <div v-if="result" class="max-w-[700px]">
    ...
    <div v-if="store.resultsAreStale" class="alert alert-warning text-sm mb-4">
    ...
    <div class="mb-8">
      ...
      >
        ...
        <div class="chat-bubble" :class="msg.role === 'agent' ? '' : 'chat-bubble-primary'">
          {{ msg.content }}
        </div>
      </div>
    </div>
